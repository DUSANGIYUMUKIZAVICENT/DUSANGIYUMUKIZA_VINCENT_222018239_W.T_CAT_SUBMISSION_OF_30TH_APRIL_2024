...
<li class="hm"><a href="index.php">HOME</a></li>
	...
	<center>
<form method="POST">
	<fieldset><legend style="text-align: center;"><h3>ADD TEAM</h3></legend>	<br>
	<label>Team Name</label><input type="text" name="nm" required placeholder="Enter team name"><br><br>
	<label>Team Coacher</label><input type="text" name="ch" required placeholder="Enter coacher name"><br><br>
	<label>Creation date</label><input type="date" name="dt" required><br><br>
	<input type="submit" name="bt" value="ADD"><button onclick="history.back()">Back</button>
</fieldset>
...
if (isset($_POST['bt']))
 {
	$tm=$con->query("INSERT INTO team VALUES ('','$_POST[nm]','$_POST[ch]','$_POST[dt]')");
	if ($tm)
	 {header("refresh:1;");
